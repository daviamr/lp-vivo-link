...
export default function PrivacyPolicyBody() {
  ...
  return (
    <div className="mt-10 space-y-1">
      ...
      Lorem ipsum, dolor sit amet consectetur adipisicing elit. Modi saepe veniam harum odio, laboriosam fugiat, sed fuga nesciunt optio, voluptas aperiam animi eos. Nam nisi repudiandae, obcaecati dolore sit quia!
    </div>
  )
}
