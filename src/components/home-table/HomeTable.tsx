...
export function HomeTable() {
  return (
    <div className="max-w-255 bg-white rounded-sm m-auto">
      ...
      <div className="flex flex-col items-center md:flex-row md:items-baseline justify-center">

        <div className="w-full">
          <p className="bg-[#EFEDF2] text-[#6B6975] font-semibold rounded-full py-2 px-8 text-sm w-max m-auto my-4 md:ml-auto md:mr-6 md:mb-4 md:mt-0">
            Internet Convencional</p>
          <ul className="text-sm text-[#6B6975] text-center md:text-right">
            <li className="flex h-14.5 items-center justify-baseline md:justify-end border-y border-[#EFEDF2] p-4">
              Banda compartilhada, oscila
            </li>
            <li className="flex h-14.5 items-center justify-baseline md:justify-end border-b border-[#EFEDF2] p-4">
              Atendimento padrão, sem prioridade
            </li>
            <li className="flex h-14.5 items-center justify-baseline md:justify-end border-b border-[#EFEDF2] p-4">
              Sem SLA formal
            </li>
            <li className="flex h-14.5 items-center justify-baseline md:justify-end p-4">
              Navegação, e-mail, tarefas do dia a dia
            </li>
          </ul>
        </div>

        <div className="border-y w-full md:w-auto md:border-y-0 md:border-x">
          <p className="mt-4 shadow-md text-[#E73871] font-bold text-[20px] rounded-full w-max m-auto mb-4 py-1.25 px-1 md:mt-0">VS</p>
          <ul>
            <li className="p-4 border-y border-[#EFEDF2] flex items-center gap-2 h-14.5">
              <SignalMedium size={20} className="text-[#E73871]" /> Velocidade
            </li>
            <li className="p-4 border-b border-[#EFEDF2] flex items-center gap-2 h-14.5">
        ...
        <div className="w-full border-2 border-[#5A088A] rounded-md py-4">
          ...
          <ul className="text-sm text-[#221C2E] font-semibold text-left">
            ...
            <li className="p-4 flex items-center gap-2 h-14.5">
